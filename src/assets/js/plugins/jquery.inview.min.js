        ...
        if ((j = k.length)) {
            ...
            if (!(b = e)) {
                ...
                if (!g.height && ((b = h.compatMode) || !d.support.boxModel))
                    (b = 'CSS1Compat' === b ? f : h.body), (g = { height: b.clientHeight, width: b.clientWidth })
                b = g
            }
            e = b
            for (
                ...
                if (d.contains(f, k[n])) {
                    ...
                    c.top + l > a.top && c.top < a.top + e.height && c.left + m > a.left && c.left < a.left + e.width
                        ? ((m = a.left > c.left ? 'right' : a.left + e.width < c.left + m ? 'left' : 'both'),
                          (l = a.top > c.top ? 'bottom' : a.top + e.height < c.top + l ? 'top' : 'both'),
                          (c = m + '-' + l),
                          (!g || g !== c) && b.data('inview', c).trigger('inview', [!0, m, l]))
