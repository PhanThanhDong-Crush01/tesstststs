    ...
    a.instagramFeed = function (f) {
        function g(d) {
            if ('string' == typeof d) {
                ...
                !f &&
                    0 < h.cache_time &&
                    (localStorage.setItem(m, JSON.stringify(d)), localStorage.setItem(n, new Date().getTime()))
            }
            if (((d = d[0].graphql.user || d[0].graphql.hashtag), '' != h.container)) {
                ...
                h.display_profile &&
                    ...
                    !j &&
                        h.display_biography &&
                        (l += "<p class='instagram_biography'" + k.profile_biography + '>' + d.biography + '</p>'),
                    (l += '</div>'))
                ...
                if (h.display_gallery)
                    if ('undefined' != typeof d.is_private && !0 === d.is_private)
                        l += '<p class="instagram_private"><strong>This profile is private</strong></p>'
                    else {
        ...
        if ('' == h.username && '' == h.tag)
            return h.on_error('Instagram Feed: Error, no username nor tag defined.', 1), !1
        if (
            ...
            return h.on_error('Instagram Feed: Error, neither container found nor callback defined.', 2), !1
        var j = '' == h.username,
